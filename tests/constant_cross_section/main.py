...
from mcmc import log_ml, run_mcmc
...
if __name__ == '__main__':
    ...
    N0 = calculate_log_N0(10**rho0, 10**v0, ns0, 10**sigma0)
    ...
    initial = np.array([N0, v0, ns0, sigma0])
    soln = minimize(nll, initial, args=(x, y, yerr))
    N0_ml, v0_ml, ns0_ml, sigma0_ml = soln.x

    logM200, logc200 = find_nfw_params(10 ** N0_ml, 10 ** v0_ml, ns0_ml, 10 ** sigma0_ml,
                                       10., np.log10(c_M_relation(10.)))
    sol = np.array([N0_ml, v0_ml, ns0_ml, sigma0_ml, logM200, logc200])
