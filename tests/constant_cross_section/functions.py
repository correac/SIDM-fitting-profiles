...
def find_r1(x, rho0, v0, ns0, t_age, sigma0):
    """
    ...
    """
    sigma_v_weight = sigma_vel_weight(x, ns0, v0, sigma0) # km/s cm^2/g
...
def find_rho0(N0, t_age, v0, ns0, sigma0):
    Msun_in_cgs = 1.98848e33
    kpc_in_cgs = 3.08567758e21

    t_age_cgs = t_age * 1e9 * 365.24 * 24 * 3600  # sec
    sigma_v_weight = sigma_vel_weight(1, ns0, v0, sigma0) * 1e5  # 1/s cm^3/g
...
def calculate_log_N0(rho0, v0, ns0, sigma0):
    """
    Calculates the number of scattering events within r0.
    """
    Msun_in_cgs = 1.98848e33
    ...
    sigma_v_weight = sigma_vel_weight(1, ns0, v0, sigma0) # km/s cm^2/g
    sigma_v_weight *= 1e5 # cm^3/s/g
...
def find_nfw_params(N0, v0, ns0, sigma0, log10M200, log10c200):
