...
def plot_solution_default(xdata, ydata, yerrdata, soln, output_name, output_file):

    # Extract solution:
    log10N0, log10v0, ns0, log10sigma0, log10w0, log10M200, log10c200 = soln
    N0 = 10 ** log10N0
    v0 = 10 ** log10v0
    ...
    r1, rho1, r0, rho0, rs, rhos = model_params(N0, v0, ns0, sigma0, w0, log10M200, c200)
    ...
    floats = np.array([r1, np.log10(rho1), r0, np.log10(rho0),
                       rs, np.log10(rhos), c200, log10M200,
    ...
    xrange = 10 ** xrange
    model = rho_joint_profiles(xrange, r1, r0, rho0, ns0, log10M200, c200)
