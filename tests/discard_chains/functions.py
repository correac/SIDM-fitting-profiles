...
def sigma_vel_weight(x, v0, sigma0):
    """
...
def find_r1(x, rho0, v0, t_age, sigma0):
    """
    ...
    """
    sigma_v_weight = sigma_vel_weight(x, v0, sigma0) # km/s cm^2/g
    sigma_v_weight *= 1e5 # cm^3 / s / g
    rho = rho_isothermal(x) * rho0
    f = t_age * sigma_v_weight * rho
    f -= 1.0
    return f

def find_rho0(N0, t_age, v0, sigma0):
    Msun_in_cgs = 1.98848e33
    kpc_in_cgs = 3.08567758e21

    t_age_cgs = t_age * 1e9 * 365.24 * 24 * 3600  # sec
    sigma_v_weight = sigma_vel_weight(1, v0, sigma0) * 1e5  # 1/s cm^3/g
...
def calculate_log_N0(rho0, v0, sigma0):
    """
    ...
    sigma_v_weight = sigma_vel_weight(1, v0, sigma0) # km/s cm^2/g
    sigma_v_weight *= 1e5 # cm^3/s/g
...
def find_nfw_params(N0, v0, sigma0, log10M200, log10c200):
    ...
    sol = root(find_c200_M200, [log10M200, log10c200], args=(r1, np.log10(rho1), np.log10(M1)),
