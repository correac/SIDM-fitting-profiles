...
from functions import calc_rs, calc_rhos, tage
...
def model_params(N0, v0, sigma0,  log10M200, c200):
...
def plot_solution(xdata, ydata, yerrdata, soln, output_name, output_file):
    ...
    # Extract solution:
    N0, v0, sigma0, logM200, logc200 = soln
    N0 = 10 ** N0
    v0 = 10 ** v0
    sigma0 = 10 ** sigma0
    c200 = 10** logc200
    ...
    r1, rho1, r0, rho0, rs, rhos = model_params(N0, v0, sigma0, logM200, c200)
...
def plot_isothermal_fit(xdata, ydata, yerrdata, N0, v0, sigma0, output_name, output_veldisp):

    t_age = 7.5  # Gyr - assuming constant halo age
    rho0 = find_rho0(N0, t_age, v0, sigma0) # Msun / kpc^3
    ...
    veldisp = v0 * velocity_dispersion(xrange/ r0)
...
def output_best_fit_params(sol_median, sol_upper, sol_lower, output_file):
    ...
    N0, v0, med_sigma0, log10M200, c200 = sol_median
    med_floats = np.array([c200, log10M200,N0, v0, med_sigma0], dtype="object")

    N0, v0, sigma0, log10M200, c200 = sol_upper
    upp_floats = np.array([c200, log10M200,N0, v0, sigma0], dtype="object")

    N0, v0, sigma0, log10M200, c200 = sol_lower
    low_floats = np.array([c200, log10M200,N0, v0, sigma0], dtype="object")
    ...
    names = np.array(['c200', 'M200','N0', 'v0', 'sigma0'])
